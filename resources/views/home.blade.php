...
<section class="container mx-auto px-4 py-8 bg-white">
    <h1 class="text-2xl font-bold mb-6 ml-12 text-gray-800">Avis Clients</h1>

    <!-- Bouton pour accéder au formulaire d'avis -->
    <div class="mb-6 ml-12">
        <a href="review/create" class="inline-block bg-gray-600 text-white font-semibold text-lg py-2 px-4 rounded-lg shadow hover:bg-gray-800 transition duration-300">
            Laisser un avis
        </a>
    </div>
    ...
    <div class="relative">
        ...
        <!-- Navigation Buttons -->
        <button id="prevBtn" class="absolute top-1/2 left-0 transform -translate-y-1/2 bg-gray-600 text-white px-4 py-2 rounded-lg shadow hover:bg-gray-700">
            &#10094;
        </button>
        <button id="nextBtn" class="absolute top-1/2 right-0 transform -translate-y-1/2 bg-gray-600 text-white px-4 py-2 rounded-lg shadow hover:bg-gray-700">
            &#10095;
        </button>
    </div>
    ...
    <div class="text-center mt-12">
        <a href="allreviews" class="inline-block bg-gray-600 text-white py-2 px-4 text-lg font-semibold rounded-lg shadow hover:bg-gray-700 transition duration-300">
            Voir tous les avis
        </a>
    </div>
</section>
