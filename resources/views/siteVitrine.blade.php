...
@section('content')
    ...
    <section class="container mx-auto px-4 py-16 bg-gray-50 mt-8 section-background">
        <div class="flex justify-center items-center space-x-4">
            ...
            <!-- Troisième SVG -->
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" style="fill: #ffffff;transform: ;msFilter:; stroke: #000000; stroke-width: 0.4px;"><path d="M20 3H4c-1.103 0-2 .897-2 2v11c0 1.103.897 2 2 2h7v2H8v2h8v-2h-3v-2h7c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2zM4 14V5h16l.002 9H4z"></path></svg>
        </div>
    ...
    <section class="container mx-auto px-4 py-16 bg-gray-50">
        <div class="text-center mb-8">
            <p class="text-gray-700 text-lg my-12 mx-12">
                Présentez votre entreprise de manière élégante et professionnelle avec nos sites vitrines sur mesure, conçus pour mettre en valeur vos services et captiver vos visiteurs.
            </p>
            <div class="image-container">
            <img src="/images/screenshot.jpg" alt="Exemple de site vitrine" class="scrolling-image mx-auto h-80  rounded-lg">
        </div>
        </div>
        ...
        <section id="services" class="container mx-auto px-4 py-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-sky-700 mb-8 text-center">Nos Services de Création de Sites Vitrines</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                <!-- Service 1 -->
                <div class="bg-white shadow-lg rounded-lg p-6 text-center">
                    <svg class="mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" style="fill: #0369a1;transform: ;msFilter:;"><path d="M20 3H4c-1.103 0-2 .897-2 2v11c0 1.103.897 2 2 2h7v2H8v2h8v-2h-3v-2h7c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2zM4 14V5h16l.002 9H4z"></path></svg>
                    <h3 class="text-2xl font-semibold text-sky-700 mb-2">Design Moderne et Élégant</h3>
                    <p class="text-lg text-gray-700">
                        Nous concevons des sites vitrines avec un <strong>design moderne et élégant</strong> pour refléter l’image de votre entreprise et attirer vos visiteurs.
                    </p>
                </div>
                <!-- Service 2 -->
                <div class="bg-white shadow-lg rounded-lg p-6 text-center">
                    ...
                    <p class="text-lg text-gray-700">
                        Tous nos sites sont conçus pour être entièrement <strong>responsive</strong>, garantissant une expérience utilisateur fluide sur tous les appareils.
                    </p>
                </div>
                <!-- Service 3 -->
                <div class="bg-white shadow-lg rounded-lg p-6 text-center">
                    ...
                    <p class="text-lg text-gray-700">
                        Chaque site est optimisé pour les moteurs de recherche afin de garantir une meilleure visibilité et un <strong>meilleur référencement</strong>.
                    </p>
                </div>
                <!-- Service 4 -->
                <div class="bg-white shadow-lg rounded-lg p-6 text-center">
                    <div class="flex justify-center space-x-4 mb-4">
                        <svg class="" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" style="fill: #0369a1;transform: ;msFilter:;">
                    ...
                    <p class="text-lg text-gray-700">
                        Nous nous assurons que votre site est conforme aux normes d'<strong>accessibilité</strong> et au <strong>RGPD</strong> pour une utilisation optimale et sécurisée.
                    </p>
                </div>
                <!-- Service 5 -->
                <div class="bg-white shadow-lg rounded-lg p-6 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#0369a1" class="w-12 h-12 mx-auto mb-4">
                    ...
                    <p class="text-lg text-gray-700">
                        Nous offrons des services de <strong>maintenance sans abonnement</strong> pour garantir la pérennité et le bon fonctionnement de votre site.
                    </p>
                </div>
                <!-- Service 6 -->
                <div class="bg-white shadow-lg rounded-lg p-6 text-center">
                    <svg class="mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" style="fill: #0369a1;transform: ;msFilter:;"><path d="M3.433 17.325 3.079 19.8a1 1 0 0 0 1.131 1.131l2.475-.354C7.06 20.524 8 18 8 18s.472.405.665.466c.412.13.813-.274.948-.684L10 16.01s.577.292.786.335c.266.055.524-.109.707-.293a.988.988 0 0 0 .241-.391L12 14.01s.675.187.906.214c.263.03.519-.104.707-.293l1.138-1.137a5.502 5.502 0 0 0 5.581-1.338 5.507 5.507 0 0 0 0-7.778 5.507 5.507 0 0 0-7.778 0 5.5 5.5 0 0 0-1.338 5.581l-7.501 7.5a.994.994 0 0 0-.282.566zM18.504 5.506a2.919 2.919 0 0 1 0 4.122l-4.122-4.122a2.919 2.919 0 0 1 4.122 0z"></path></svg>
                    <h3 class="text-2xl font-semibold text-sky-700 mb-2">Propriété Totale</h3>
                    <p class="text-lg text-gray-700">
                        Vous bénéficiez de la <strong>pleine propriété de votre site</strong>, avec tous les droits pour gérer et modifier votre contenu comme vous le souhaitez.
                    </p>
                </div>
            </div>
        </section>
        ...
        <section id="contact" class="bg-sky-800 text-white py-16">
            <div class="container mx-auto px-4 text-center">
                ...
                <p class="text-lg md:text-xl my-6">Contactez-nous dès aujourd'hui pour discuter de votre projet et obtenir un devis personnalisé.</p>
                ...
                <p class="text-lg md:text-xl my-6">Vous désirez un site E-commerce? Visitez les services <strong class="text-2xl">E-commerce</strong>.</p>
                <a href="/site-Ecommerce" class="bg-white text-sky-700 hover:bg-gray-200 font-semibold py-3 px-6 rounded-lg shadow-md">E-commerce</a>
            </div>
