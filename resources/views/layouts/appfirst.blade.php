...
<body>
    <header id="header" class="fixed h-screen flex items-center justify-center bg-cover bg-center">
        ...
        <div class="h-screen lg:h-full flex flex-col items-center justify-center">
            ...
            <div class="text-gray-100 text-3xl uppercase italic mb-48 sm:mb-24 text-center text-shadow-custom">
                ...
                <div
                    ...
                    {{-- <svg class="mr-4" width="20" height="20" viewBox="0 0 153.10083 127.33417"
                        ...
                        <sodipodi:namedview id="namedview1" pagecolor="#ffffff" bordercolor="#000000"
                            ...
                            inkscape:zoom="0.70110129" inkscape:cx="288.8313" inkscape:cy="126.22998"
