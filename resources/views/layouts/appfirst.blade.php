...
<body>
    ...
    <header id="header" class="h-screen flex items-center justify-center bg-cover bg-center"
        ...
        <div class="h-screen lg:h-full flex flex-col items-center justify-center">
                ...
                <g inkscape:groupmode="layer" inkscape:label="Image" id="g1">
                    <g transform="matrix(2.8405871,0,0,2.8033497,983.75025,907.698)" id="g4">
                        <path
                            ...
                            style="opacity:0;fill:#e1e1e1" id="path2" inkscape:label="path4" />
                        <path
                            ...
                            style="opacity:0;fill:#e1e1e1" id="path1" inkscape:label="path3" />
                        <path
                            ...
                            style="opacity:0;fill:#e1e1e1" id="path4" inkscape:label="path2" />
                        <path
                            ...
                            style="opacity:0;fill:#e1e1e1" id="path3" inkscape:label="path1" />
                    </g>
                    <g id="g5" transform="matrix(0.49947185,0,0,0.62843793,456.67801,480.68109)"
                        inkscape:groupmode="layer">
                        <path style="opacity:0;fill:#e1e1e1" id="path6" inkscape:label="path5" />
                    </g>
                    <path style="opacity:0;fill:#e1e1e1"
            ...
            <div class="text-gray-100 text-3xl uppercase italic mb-48 sm:mb-24 text-center">
