...
<section class="container mx-auto px-4 py-16 bg-gray-50 mt-8 section-background">
    <div class="flex justify-center items-center space-x-4">
        <!-- Premier SVG -->
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" style="fill: #ffffff; stroke: #000000; stroke-width: 0.5px;">
        ...
        <!-- Deuxième SVG -->
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" class="fill-current text-sky-700 ml-4 mr-2" style="fill: #ffffff; stroke: #000000; stroke-width: 0.6px;">
...
<div class="container mx-auto px-4 py-16 bg-gray-50">
    ...
    <div class="bg-white shadow-lg rounded-lg p-8 w-full">
        ...
        <p class="text-gray-700 mb-6">Dernière mise à jour : 28/08/2024</p>
        ...
        <p class="text-gray-700 mb-6">
            Vos données personnelles sont conservées sur une boîte e-mail hébergée chez O2Switch via leur service Webmail. Nous ne conserverons
        ...
        Pour exercer ces droits, veuillez nous contacter à l'adresse suivante : <a href="mailto:contact@aj-web.fr" class="text-sky-700 hover:underline">contact@aj-web.fr</a>.
        </p>
        ...
        <p class="text-gray-700 mb-6">
            ...
            suivante : <a href="mailto:contact@aj-web.fr" class="text-sky-700 hover:underline">contact@aj-web.fr</a>.
        </p>
    </div>
</div>
